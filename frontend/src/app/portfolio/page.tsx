...
import PortfolioAdvisorPanel from "@/components/portfolio/PortfolioAdvisorPanel";
...
export default function PortfolioPage() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#060709] p-4 text-white/60">
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#060709] p-4">
        ...
        >
          ...
          <Link href="/auth/login?redirectTo=/portfolio" className="block w-full py-4 bg-emerald-500 text-black font-bold rounded-2xl hover:bg-emerald-400 transition-all">
            Go to Login
          </Link>
        </motion.div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#060709] text-white p-4 md:p-8 page-enter">
      {/* Header */}
      <header className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
        ...
        >
          <button 
            ...
            className="px-6 py-3 bg-emerald-500 text-black font-bold rounded-xl hover:bg-emerald-400 transition-all flex items-center space-x-2 shadow-[0_0_20px_rgba(16,185,129,0.2)] hover-scale hover-glow"
          >
            <span>+</span>
            <span>Add Asset</span>
          </button>
      ...
      <main className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Charts Section */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-slideUp delay-200">
        ...
        <div className="animate-fadeInUp delay-300">
          <PortfolioAdvisorPanel summary={summary} />
        </div>
